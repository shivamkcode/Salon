    ...
    >
      <div
        className={`flex flex-col gap-6 md:gap-8 lg:gap-10 h-full px-10 md:px-16 lg:px-28 ${
          male
            ? "justify-end text-center items-center pb-10 w-[100%] md:w-[80%] lg:w-[70%] "
            : "justify-center w-[300px] md:w-[400px] lg:w-[600px]"
        }`}
      >
        ...
        <h1>
          {male
            ? "Discover an unforgettable experience where style meets tradition and every haircut becomes a statement of your individuality."
            : "Divide your UNIQUENESS by your hair"}
        </h1>
          <div className="backdrop-blur-2xl rounded-br-3xl rounded-bl-3xl rounded-tr-3xl p-6 md:p-8 lg:p-10 border border-white flex flex-col gap-2 md:gap-4 lg:gap-6">
            <h3>Your First Time?</h3>
            <h4 className="uppercase">
              <span className="text-3xl md:text-4xl ">-20%</span> for the first
              classic {male ? "haircut" : "hair coloring"}
            </h4>
            <Link
