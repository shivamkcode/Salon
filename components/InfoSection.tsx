...
const InfoSection: React.FC<Props> = (props) => {
  return (
    <div className={`flex flex-col md:flex-row ${props.sex === 'male' ? 'bg-black text-white' : 'bg-[#DD1619]'} opacity-95 gap-8 p-6 md:p-8 md:py-14 lg:p-10 lg:py-20 justify-center md:justify-evenly items-center md:items-start text-center contain-content`}>
