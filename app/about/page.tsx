      ...
      <div className="p-6 md:p-8 lg:p-10 md:py-10 lg:py-16 flex flex-col lg:flex-row gap-16">
        <div className="flex-1 text-start flex flex-col gap-6 md:gap-10 lg:gap-16 leading-loose my-[auto]">
          ...
          <p className="opacity-70">
            ...
            men. Our team of skilled professionals is dedicated to delivering a
            tailored and sophisticated experience that caters to your unique
            ...
            offer a range of services designed to leave you looking and feeling
            your best. At {gender === "male" ? "À-ONÈ" : "ÀYÈSHÀ_"}, we believe
            that every man deserves to enjoy a luxurious and personalized
            grooming experience in a comfortable and relaxing environment. Join
            us and discover the difference of high-quality salon services
